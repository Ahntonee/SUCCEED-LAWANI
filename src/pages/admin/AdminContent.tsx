...
const sections: ContentSection[] = [
  {
    ...
    keys: [
      ...
      { key: 'gallery_cover_image', label: 'Gallery Section Cover Photo', type: 'image' },
  ...
  },
  {
    ...
    keys: [
      ...
      { key: 'skill_2_name',  label: 'Skill 2 — Name',        placeholder: 'Visual Arts & Photography' },
      { key: 'skill_2_level', label: 'Skill 2 — Level',        placeholder: '90%' },
      { key: 'skill_2_desc',  label: 'Skill 2 — Description',  placeholder: 'Photography, visual storytelling, creative direction' },
  ...
  },
  {
    ...
    keys: [
      { key: 'seo_home_title',    label: 'Home — Title',       placeholder: 'Music, Gallery & Digital Marketing', note: 'Shown as: [your text] | Succeed Michael Lawani. Leave blank for site default.' },
      { key: 'seo_home_desc',     label: 'Home — Description', multiline: true, placeholder: 'Official website of Succeed Michael Lawani — gospel artist, visual creator, and digital marketing expert.' },
      ...
      { key: 'seo_events_desc',   label: 'Events — Description', multiline: true, placeholder: 'Upcoming concerts, speaking engagements, and events.' },
      { key: 'seo_blog_title',    label: 'Blog — Title',       placeholder: 'Blog — Music, Marketing & Creative Insights', note: 'Shown as: [your text] | Succeed Michael Lawani' },
      { key: 'seo_blog_desc',     label: 'Blog — Description', multiline: true, placeholder: 'Read Succeed Michael Lawani\'s blog — thoughts on music, digital marketing, faith, and the creative journey.' },
      { key: 'seo_contact_title', label: 'Contact — Title',    placeholder: 'Contact', note: 'Shown as: Contact | Succeed Michael Lawani' },
      { key: 'seo_contact_desc',  label: 'Contact — Description', multiline: true, placeholder: 'Get in touch for bookings, music collaborations, and digital marketing consultations.' },
      ...
      { key: 'seo_shop_desc',     label: 'Shop — Description', multiline: true, placeholder: 'Shop exclusive music merch and digital products from Succeeder Designs.' },
    ],
  },
  {
    ...
    keys: [
      ...
      { key: 'email_cta_subtitle', label: 'Subheading', multiline: true, placeholder: 'Get exclusive music releases, gallery updates, and marketing insights delivered to your inbox.' },
    ],
  },
  {
